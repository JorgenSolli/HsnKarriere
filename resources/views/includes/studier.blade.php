...
<select name="studieretning" id="studieretning" class="form-control">
    ...
    </optgroup><optgroup label="Institutt for Sosialfag">
    ...
    </optgroup><optgroup label="Institutt for Prosess, Energi og Miljøteknologi">
    ...
    </optgroup><optgroup label="Institutt for Læreutdanning">
